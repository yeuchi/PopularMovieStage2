...
class MovieNetworkRepository @Inject constructor(
    ...
    suspend fun requestReviews(selectedMovie: Movie) {
        val url = NetworkUtils.buildReviewUrl(selectedMovie.id.toString())
    ...
    suspend fun requestTrailers(
        ...
        val url = NetworkUtils.buildVideoUrl(selectedMovie.id.toString())
